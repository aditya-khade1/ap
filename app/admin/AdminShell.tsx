      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-line bg-white px-4 py-3 lg:hidden">
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-xl transition hover:bg-ink/5"
            aria-label="Open menu"
          >
            <Menu size={20} />
          </button>
          <span className="font-serif text-lg font-semibold">Admin Panel</span>
          <div className="grid h-10 w-10 place-items-center rounded-full bg-brand-dark text-xs font-bold text-white">
            AP
          </div>
        </header>
