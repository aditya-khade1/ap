    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <div className="mt-8 flex w-full flex-col gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center gap-2 rounded-full bg-green-600 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-green-700"
        >
        ...
        <Link
          href="/"
          className="mt-1 text-sm font-medium text-rose hover:underline"
        >
          Try going back home
        </Link>
      </div>
